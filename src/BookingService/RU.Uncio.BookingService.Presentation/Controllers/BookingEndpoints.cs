...
namespace RU.Uncio.BookingService.Presentation.Controllers
{
    /// <summary>
    /// Mapping extensions
    /// </summary>
    public static class BookingEndpoints
    {
        ...
        {
            endpoints.MapPost("Events/{eventId}/book", [Authorize] async ([FromRoute] Guid eventId,
            ...
            endpoints.MapDelete("/bookings/{id}", [Authorize] async ([FromRoute] Guid id, IBookingService service, ClaimsPrincipal user, CancellationToken token) =>
            {
                try
                {
                    ...
                    await service.CancelBookingByIdAsync(userId, userRole, id, token);
